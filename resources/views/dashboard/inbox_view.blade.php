...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">البريد</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    الرسائل</span>
            </div>
        </div>
            ...
            <div class="card mg-b-20 mg-md-b-0">
                <div class="card-body">
                    <div class="main-content-left main-content-left-mail">
                        <a class="btn btn-main-primary btn-compose" href="" id="btnCompose">ارسال بريد</a>

                        <div class="main-mail-menu">
                            <nav class="nav main-nav-column mg-b-20">
                                <a class="nav-link active" href=""><i class="bx bxs-inbox"></i> الخاص
                                    <span>20</span></a>


                                <a class="nav-link" href=""><i class="bx bx-send"></i> ارسال اميل  <span>8</span></a>


                                <a class="nav-link" href=""><i class="bx bx-trash"></i> المحذوفات <span>6</span></a>
                            </nav>
            ...
            <div class="card">
                <div class="main-content-body main-content-body-mail card-body">
                    <div class="main-mail-header">
                        <div>
                            <h4 class="main-content-title mg-b-5">البريد</h4>
                            <p>لقد تلقيت 5 رسائل جديده</p>
                        </div>
                        <div>
                    ...
                    <div class="main-mail-options">
                        ...
                        <div class="btn-group">
                            <button class="btn btn-light"><i class="bx bx-refresh"></i></button> 
								...
								<button
                                class="btn btn-light disabled"><i class="bx bx-info-circle"></i></button> 
								<button
                                class="btn btn-light disabled"><i class="bx bx-trash"></i></button> 
                    ...
                    <div class="main-mail-list">
                        ...
                        <div class="main-mail-item unread">
                            ...
                            <div class="main-img-user"><img alt="" src="{{ URL::asset('assets/img/faces/5.jpg') }}">
                            </div>
