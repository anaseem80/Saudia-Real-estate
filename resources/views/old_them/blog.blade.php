                ...
                <div class="col-span-12">
                    <div class="max-w-[700px]  mx-auto text-center text-white relative z-[1]">
                        ...
                        <h1 class="font-recoleta text-[32px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl">
                            كل ما عليك معرفته عن تجارة العقارات في السعوديه
                        </h1>

                        <p class="text-base mt-5 max-w-[500px] mx-auto text-center">
                            تَعِد السعوديه المقيمين فيها ببحر غني بالفرص الذهبية على كافة الأصعدة، ولا سيما العقارية منها، إذ تقدم العديد من التسهيلات التي تساعدهم في ازدهار أعمالهم واقتناص الفرص المناسبة. هذا وتحتل السعوديه مكانةً متقدمة بين أفضل دول العالم للاستثمار العقاري، ويُعزى ذلك للظروف المناسبة للاستثمار والقوانين المعمول بها التي من شأنها الحد من العقبات والصعوبات التي قد تواجه أي مستثمر أو وكيل عقاري يفكر في تجارة العقارات في السعوديه
                        </p>
                    </div>
                </div>
            </div>
