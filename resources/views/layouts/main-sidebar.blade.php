    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @can('الاقسام')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('نوع العقار')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'propertyTypeview')) }}">نوع العقار</a>
            ...
            @can('الدول و المدن')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">الدول و المدن</span><i
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = 'dashboard')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon"
                            viewBox="0 0 24 24">
                            <g>
                                <rect fill="none" />
                    ...
                    <ul class="slide-menu">
                        @can('تغيير اعدادات الموقع و التطبيق')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'setting_web')) }}">تغيير اعدادات الموقع و
                                    التطبيق</a>
                            </li>
                        @endcan
                        @can('تغير الاعدادت الرئيسيه')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'setting')) }}">تغير الاعدادت الرئيسيه</a>
                            </li>
                        @endcan
                        {{-- @can('update', $post) --}}
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'profile')) }}">تغير اعدادات الحساب</a>
                        </li>
                        {{-- @endcan --}}
                        {{-- <li><a class="slide-item" href="{{ url('/' . $page='invoice') }}">Invoice</a></li>
					<li><a class="slide-item" href="{{ url('/' . $page='pricing') }}">Pricing</a></li>
